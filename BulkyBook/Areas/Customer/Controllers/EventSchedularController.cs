...
{
    public class EventSchedularFilter : Filter
    {
        public int? SubcategoryId { get; set; }
        public int? SpecialityId { get; set; }
    }
    [Area("Customer")]
    public class EventSchedularController : Controller
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IWebHostEnvironment _hostEnvironment;
        private static string message;
        public EventSchedularController(IUnitOfWork unitOfWork, IWebHostEnvironment hostEnvironment)
        {
            _unitOfWork = unitOfWork;
            _hostEnvironment = hostEnvironment;
        }
        public async Task<IActionResult> Index(string searchstring, string locationstring, int? searchcategoryid, string subcategory, EventSchedularFilter filter, int businessPage = 1)
        {
